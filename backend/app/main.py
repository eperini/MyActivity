...
from app.api.routes import auth, tasks, habits, recurrences, telegram, pomodoro, push, export, stats, google_calendar, backup, tags, comments, quickadd, shortcut, templates, areas, projects, custom_fields, dependencies, automations, sprints, time_logs, jira, reports, tempo, epics, invitations, notifications, headings
...
app.include_router(tempo.router, prefix="/api", tags=["tempo"])
...
app.include_router(headings.router, prefix="/api", tags=["headings"])
