  ...
  return (
    <div className="space-y-2.5">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-1">
          <input
            ...
            className="w-11 bg-zinc-900 border border-zinc-700 rounded-lg px-1.5 py-1.5 text-sm text-zinc-300 outline-none text-center focus:border-zinc-500"
            placeholder="0"
          />
      ...
      <input
        ...
        className="w-full bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-1.5 text-sm text-zinc-300 outline-none placeholder-zinc-600 focus:border-zinc-500"
        onKeyDown={(e) => {
      ...
      <div className="flex gap-2">
        <button
          onClick={onCancel}
          className="flex-1 px-3 py-1.5 bg-zinc-700 hover:bg-zinc-600 rounded-lg text-sm text-zinc-300 transition-colors"
        >
          Annulla
        </button>
        <button
          ...
          className="flex-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-500 disabled:bg-zinc-700 disabled:text-zinc-500 rounded-lg text-sm text-white font-medium transition-colors"
        >
          {saving ? "..." : "Salva"}
        </button>
      </div>
